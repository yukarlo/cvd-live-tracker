internal object LibraryVersion {
    internal const val BUILD_TOOLS = "4.2.0-alpha15"
    ...
    internal const val ANDROID_NAVIGATION = "2.3.1"
    internal const val GOOGLE_MATERIAL = "1.3.0-alpha03"
    internal const val SWIPE_REFRESH_LAYOUT = "1.2.0-alpha01"
    internal const val DAGGER_HILT_ANDROID = "2.28.3-alpha"
    internal const val DAGGER_HILT = "1.0.0-alpha02"
    internal const val ANDROID_LIFECYCLE = "2.3.0-alpha07"
    internal const val RECYCLERVIEW = "1.2.0-alpha06"
    internal const val RETROFIT = "2.9.0"
    internal const val GSON = "2.8.6"
    internal const val COROUTINES = "1.4.1"
    internal const val OKHTTP3 = "4.8.1"
    internal const val MOSHI = "2.9.0"
    internal const val PAGING = "3.0.0-alpha08"
    internal const val COIL = "1.0.0"
    internal const val ADAPTER_DELEGATE = "4.3.0"
    internal const val WILLIAM_CHART = "3.7.2"
