internal object LibraryVersion {
    ...
    internal const val APP_COMPACT = "1.3.0-beta01"
    internal const val CONSTRAINT_LAYOUT = "2.1.0-alpha2"
    internal const val CORE_KTX = "1.5.0-beta01"
    internal const val ANDROID_NAVIGATION = "2.3.3"
    internal const val GOOGLE_MATERIAL = "1.3.0"
    internal const val SWIPE_REFRESH_LAYOUT = "1.2.0-alpha01"
    internal const val DAGGER_HILT_ANDROID = "2.31.2-alpha"
    internal const val DAGGER_HILT = "1.0.0-alpha03"
    internal const val ANDROID_LIFECYCLE = "2.3.0"
    internal const val RECYCLERVIEW = "1.2.0-beta01"
    internal const val RETROFIT = "2.9.0"
    internal const val GSON = "2.8.6"
    internal const val COROUTINES = "1.4.2"
    internal const val OKHTTP3 = "5.0.0-alpha.2"
    ...
    internal const val WILLIAM_CHART = "3.10.1"
    internal const val CIRCULAR_IMAGE_VIEW = "3.1.0"
    internal const val SQL_DELIGHT = "1.4.3"
